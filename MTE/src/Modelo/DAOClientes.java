...
public class DAOClientes {
    ...
    public Clientes Insertar(String nomb1, String nomb2, String apell1, String apell2, String numcelu, String direc) {
    ...
    public List ObtenerDatos() {
        ...
        for (Map registro : registros) {
            Clientes client = new Clientes((int) registro.get("codcli"),
